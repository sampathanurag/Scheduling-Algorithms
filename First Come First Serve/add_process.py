...
# Function to display the id and the time remaining can be accomplished by invoking display()


class Process:
    """
    Class Process to create process objects with various attributes
    """
    ...
    def display(self):
        """
           ...
           :return: None
        """
        print("Process ID:", self.Id, "| Arrival Time:", self.arrivalTime, "| Task Time Remaining:", self.taskTime,
              "| Log:", self.log)
